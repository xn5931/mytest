  ...
  if (getData) {
    ...
    Tutorial.findByAccount(userData, (data) => {
      ...
      if (data.created ==0) {
        ...
        Tutorial.findMMMByAccount(userData, (Mdata) => {
          //console.log("Mdata...",Mdata.created);
...
// find allInfo
exports.checkAllInfos = (req, res) => {

  var getData = req.body.data;

  if (getData) {
    var userData = getData.account;
    if (userData === "998092839300328361203921832617382189389") {
      Tutorial.findAllInfo(userData, (selectData) => {
        let totalGetMMM = selectData.created;
        var MMMCount = 1000 - totalGetMMM;
        var resData = {
            "availableNum":MMMCount
          }
        res.send({ "result":resData ,"msg":"success"});
        ...
        console.log("not root post");return 0;
       }
